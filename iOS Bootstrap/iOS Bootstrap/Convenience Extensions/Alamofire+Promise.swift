...
extension Alamofire.DataRequest {
    ...
    public func response(_: PMKNamespacer, queue: DispatchQueue? = nil)
    ...
    Promise<(string: String, response: PMKAlamofireDataResponse)> {
        return Promise { seal in
    ...
    /// Adds a handler to be called once the request has finished.
    public func responseJSON(queue: DispatchQueue? = nil, options: JSONSerialization.ReadingOptions = .allowFragments)
    ...
    public func responsePropertyList(queue: DispatchQueue? = nil,
        ...
        -> Promise<(plist: Any, response: PMKAlamofireDataResponse)> {
            return Promise { seal in
     ...
     */
     ...
     - Parameter decoder: JSONDecoder, by default JSONDecoder()
     */
        public func responseDecodable<T: Decodable>(_ type: T.Type,
